...
var Syslog = exports.Syslog = function (options) {
  ...
  this.producer = new glossy.Produce({
    ...
    //TODO: 这是日志易的一个bug，如果带pid，就会无法识别为json格式，先这样吧
    //pid:      this.pid,
...
Syslog.prototype.log = function (level, msg, meta, callback) {
  ...
  localhost = meta.localhost || this.localhost;
  appId = meta.appId || this.appId;
  delete meta.localhost;
  delete meta.appId;
